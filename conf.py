...
BLOG_AUTHOR = "Entre Dev Y Ops"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/tags/index.html', '<i class=\'fa fa-tags\'"></i> Etiquetas'),
        ('/archive.html',    '<i class=\'fa fa-archive\'/></i> Archivo'),
        ('/podcast.html',    '<i class=\'fa fa-microphone\'/></i> Podcast'),
        ('/acerca-de.html',  '<i class=\'fa fa-info-circle\'/></i> Acerca de...'),
    ),
}
...
# (translatable)
LICENSE = """<a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/3.0/deed.es_ES">Licencia <img alt="Licencia Creative Commons" src="http://i.creativecommons.org/l/by-nc-sa/3.0/80x15.png" height="15px" width="80px" /></a>"""
...
# (translatable)
CONTENT_FOOTER = """Suscríbete a nuestro <a href="{site_feed}">RSS <i class='fa fa-rss'/></i></a> o síguenos en <a href="https://twitter.com/entredevyops">Twitter <i class='fa fa-twitter'/></i></a><br />&copy; {current_year} {title} por los <a href="{authors_url}">autores</a> bajo {license} &mdash; Powered by <a href="http://getnikola.com">Nikola</a>"""
CONTENT_FOOTER = CONTENT_FOOTER.format(email=BLOG_EMAIL,
                                       title=BLOG_TITLE,
                                       authors_url=SITE_URL + 'acerca-de.html#authors',
                                       site_feed=SITE_URL + 'rss.xml',
...
# (translatable)
SEARCH_FORM = """<form method="get" role="search" id="search" action="https://google.es/search" class="nav navbar-form">
<input type="hidden" name="as_sitesearch" value="%s"/>
...
BODY_END = """<script type="text/javascript">
    var _gaq = _gaq || [];
    _gaq.push(['_setAccount', 'UA-25613214-1']);
...
TWITTER_CARD = {
    ...
    'site': '@EntreDevYOps',   # twitter nick for the website
    'site:id': 370552857,      # Same as site, but the website's Twitter user ID instead.
}
